...
def show_result_dialog(ans1, ans2, ans3, ans4):
    ...
    # 📌 จุดที่ 3: สรุปผลการเล่นเกม u_ans3 = ans3.strip().lower() และ u_ans4 = ans4.strip().lower()
...
ans4 = st.text_input(
    "ข้อ 4: A `c _ t` is a popular cute pet. 🐱",
...
# 📌 จุดที่ 8: ส่งผ่านตัวแปร ans3, ans4 เข้าฟังก์ชันแสดง Dialog ผลลัพธ์
